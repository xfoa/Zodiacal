# Zodiac Mental Health: Working Notes

- Staging ground for the mental health material.
- Nothing moves to [Zodiacal Worldbuilding Notes.md](Zodiacal Worldbuilding Notes.md) until confirmed.
...
- Noise maps onto suffering in general. It does not map onto one condition.
- No player can point at a light-pattern and say "that is my diagnosis, being ruled on."
...
- The native form of care is *mirroring*: one Zodiac flying beside another.
- The name carries a dual meaning: doing the same things, and holding up a mirror.
- Mirroring is a common calling. There is no shortage of supply, and a mirror need not be someone you already know.
- The mirror matches the patient's routes and shares their feeding grounds.
...
- Sometimes a crew finds itself working with two Zodiacs instead of one. Mostly an accepted fact of working with Zodiacs; some call it inefficient.

#### No stigma

- Mental illness carries zero stigma between Zodiacs.
- This follows from the care model: if care is mirroring, the illness is a reason for company, not a mark against the bearer.
- The culture reads distress as a call for presence, not a failure of character.

#### The mirror's own risk

- Reading noise in a loved one's light for years is taxing.
- The risk is burnout, not contagion: the scream pole does not spread.
- The generational structure suggests the answer: care rotates.
- What an elder knows, an elder teaches (§11); what an elder carries, the community shares.
- Care is shared. Nobody mirrors alone for years.
...
- Care by talk needs no boarding. Speech and light-reading work at range.
- The bearer keeps full agency.
- Corps model fits distance work: a contract specialist, hired per job, starting from zero each time (§5).

#### Boarding with crew oversight

- Bounded trust. The crew witnesses what happens inside and can act on it afterward.
- The safety net is the crew, not the faction.
- Both factions provide this net: Corps crews by contract and peer structure, merges by shared consciousness.

#### Boarding uncrewed

- Boarding anyone while uncrewed is one of the riskiest things a Zodiac can do.
- An uncrewed Zodiac has no witnesses and no institutional recourse.
- The unsafe interior (see Vulnerabilities) is the general case.
- Predation is one form of it: a human boarding an uncrewed Zodiac is structurally indistinguishable from a catcher until proven otherwise (§17).
- This maps onto real-world vulnerability.
- Isolated people are easier to harm.
- The harm is harder to prove.

## When care fails

- Zodiac care fails through distance and departure.
- Human care fails through access and scarcity.

### Outrunning care

- A struggling Zodiac can simply be gone: between one conversation and the next, across the dark.
- Mirroring depends on sustained proximity, and proximity is consensual every single day.
- A mirror can follow a patient who wants to be followed. Not one who doesn't.
- The distinctively Zodiac failure is not "care was unavailable" but "care was available, and the patient left."
- A Zodiac who wants to be unreachable is unreachable: no phone to ring, no address to visit.
- Choosing isolation is frictionless.

### The horizon of worry

- The flip side of no stigma: a culture built on watching each other's light has a surveillance-by-love problem.
...
- Never frame visibility as a solution. That reading is erasure.
- No single clean disability metaphor.
- Keep every mapping multiple and partial.
- No player should say "that's about me." No player should say "that's not about anyone."
